...
def create_products(db, categories):
    ...
    products_data = [
        ...
        {"name": "Ручка шариковая синяя", "description": "Шариковая ручка 0.5 мм, экономичный расход. Упаковка 50 шт.", "price": 390, "brand": "ErichKrause", "sku": "EK-R301-50", "unit": "упаковка", "pack_qty": 50, "category_id": categories["pismennye"].id, "image_url": "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=400"},
        ...
        {"name": "Бумага А4 «SvetoCopy» 500 л.", "description": "Офисная бумага для печати, белизна 146% CIE, плотность 80 г/м².", "price": 540, "brand": "SvetoCopy", "sku": "SC-A4-500", "unit": "упаковка", "pack_qty": 500, "category_id": categories["bumaga"].id, "image_url": "https://images.unsplash.com/photo-1586075010923-2dd4570fb338?w=400"},
        ...
        {"name": "Степлер №24/6", "description": "Металлический степлер до 20 листов, скобы 24/6.", "price": 410, "brand": "KW-trio", "sku": "KW-24-6", "unit": "шт", "pack_qty": 1, "category_id": categories["ofisnye"].id, "image_url": "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=400"},
